...
SELECT TripId, TripDate, TripPrice
FROM Reservation;
...
SELECT COUNT(*)
FROM Reservation
WHERE TripPrice >= 20 AND TripPrice <= 50;

SELECT COUNT(RESERVATIONID)
FROM Reservation
WHERE TripPrice BETWEEN 20 AND 50;
